...
const Comment = () => {
    ...
    return (
        <>
            <Grid item xs={12} sm={6} md={3} pr={1} height={"200px"} display={{ sm: "flex", xs: "none" }} flexDirection={"column"} >
                <Grid item xs={12} display={"flex"} gap={2}>
                    <Grid xs={4}  display={"flex"}  alignItems={"center"} justifyContent={"center"} boxShadow={"rgb(58 61 66 / 6%) 0px 1px 0px, rgb(0 0 0 / 30%) 0px 8px 32px -16px"} borderRadius={"0.75rem"} >
                        <Image src={pic} alt="" style={{ border: "1px solid rgba(58, 61, 66, 0.06)", borderRadius: "0.75rem", width: "95%", height: "95%" }} />
                    </Grid>
                    <Grid item xs={8.9} >
                        ...
                        <Grid item xs={12} mt={2}>
                            <Typography fontSize={"20px"} fontWeight={900} color={"000"}>تله پیتزا </Typography>
                        </Grid>
