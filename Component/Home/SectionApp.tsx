...
const SectionApp = () => {
  return (
    ...
    <Grid container bgcolor={"#EDEFF0"} borderRadius={"0  0 70px 0"} pb={10} sx={{ width: { xs: "12", lg: "90%" }, display: { sm: "flex", xs: "none" } }} mt={13} display={"flex"} justifyContent={"space-around"}>
      ...
      <Grid container item lg={6} xs={12} dir={"rtl"} sx={{ paddingRight: { xs: "20px", md: "0px" }, marginRight: { md: "80px", xs: "0px" } }} >
        <Grid item mt={7}>
        ...
        <Grid item mt={8} xs={12} >
          ...
          <Grid item xs={5}  mt={2} borderRadius={2} p={1} display={"flex"} bgcolor={"#fff"} alignItems={"center"} justifyContent={"space-between"}>
        ...
        <Grid item mt={10}  xs={8} lg={12} display={"flex"} justifyContent="space-between">
          <Grid item p={1}  >
            <Image width={120} color={"#fff"} src={google} alt={",mnjhbgvf"} />
          </Grid>
          <Grid item p={1}>
            <Image width={120} src={bazar} alt={",mnjhbgvf"} />
          </Grid>
          <Grid item p={1}>
            <Image width={120} src={apple} alt={",mnjhbgvf"} />
          </Grid>
          <Grid item p={1} >
            <Image width={120} src={iapps} alt={",mnjhbgvf"} />
          </Grid>
        </Grid>
      </Grid>
    </Grid>
