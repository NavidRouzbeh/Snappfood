...
const RegistrationSeller = () => {
  return (
    <Grid container bgcolor={"#EDEFF0"} borderRadius={4} pb={10} sx={{ width:{ xs:"12", lg: "90%"} , display: { sm: "flex", xs: "none" }}} mt={18} display={"flex"} justifyContent={"space-around"}>
      ...
      <Grid container item md={6}   dir={"rtl"} sx={{paddingRight:{xs:"20px" , md:"0px"} , marginRight:{md:"90px" , xs:"0px"}}} >
        <Grid item mt={7}>
